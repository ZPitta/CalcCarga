...
<ol>
  ...
  <li>
    ...
    <ul>
      ...
      <li>
        <p>
          <strong><code>`convert_kg()`</code>:</strong> Esta função é mencionada no código, mas ainda não está totalmente implementada.
        </p>
      </li>
    </ul>
  </li>
...
<p>Para qualquer dúvida ou preocupação sobre o código ou seu uso, entre em contato com o desenvolvedor.</p>
<h6>Observação: para obter melhores resultados, execute o código em um terminal ou ambiente de console.</h6>
<br />
<h3>Contatos:</h3>
    <p>
